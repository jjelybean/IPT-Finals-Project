...
<body>
	...
	<form method="post" action="conversion.php">
		...
		<option value="AED">United Arab Emirates dirham</option>
            ...
            <option value="AZN">Azerbaijani manat</opti2on>
            ...
            <option value="GEL">Georgian lari</option>2
            ...
            <option value="MAD">Moroccan dirham</option2>
            ...
            <option value="SGD">Singapore dollar</option2>
            ...
            <option value="XAF">Central African CFA franc2</option>
		...
		<option value="AED">United Arab Emirates dirham</option>
            <option value="AFN">Afhgan Afghani</option>
            <option value="ALL">Albanian lek</option>
            <option value="AMD">Armenian dram</option>
            <option value="ANG">Netherlands Antillean guilder</option>
            <option value="AOA">Angolan kwanza</option>
